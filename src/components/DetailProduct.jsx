...
export default function DetailProduct() {
  ...
  return (
    <section className="product">
      <div className="product-info">
        ...
        <div className="product-detail">
          ...
          <div className="product-action">
            <button type="button" className="product-buy" onClick={() => setIsModalOpen(true)}>Buy Now</button>
            <button type="button" className="product-add-cart" onClick={() => setIsModalOpen(true)}>
              Add to Cart
      ...
      <AuthModal isOpen={isModalOpen} setIsModalOpen={setIsModalOpen} modalType={modalType} setModalType={setModalType} />
    </section>
  );
}
